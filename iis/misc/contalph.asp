...
<a href="#Ptoc" onclick="TOCPrint_Click()"><img src="print.gif" border="0" alt="打印目录中的主题或节点"></a><a name="Ptoc"></a>
</SPAN>
</td>
<td align="left">
<a href="#Stoc" onclick="TOCSynch_Click()"><img src="synch.gif" border="0" alt="使目录与内容窗格同步"></a><a name="Stoc"></a>
</td></tr></table>
